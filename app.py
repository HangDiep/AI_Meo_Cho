...
def predict_frame(frame, model, face_cascade, use_mediapipe=False, face_detector=None):
    if frame is None:
    ...
    if face_roi.size == 0:
        return {"status": "error", "message": "Khuôn mặt không hợp lệ"}
    ...
    return {
        ...
        "probabilities": {
            ...
            "incorrect_mask": float(prediction[2]),
        }
    }
